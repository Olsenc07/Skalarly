...
function ImageCropperComponent_div_4_ng_container_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵlistener("mousedown", function ImageCropperComponent_div_4_ng_container_2_Template_span_mousedown_1_listener($event) {
      ...
      return ɵɵresetView(ctx_r10.startMove($event, ctx_r10.moveTypes.Resize, "topleft"));
    })("touchstart", function ImageCropperComponent_div_4_ng_container_2_Template_span_touchstart_1_listener($event) {
      ɵɵrestoreView(_r11);
      const ctx_r12 = ɵɵnextContext(2);
      return ɵɵresetView(ctx_r12.startMove($event, ctx_r12.moveTypes.Resize, "topleft"));
    });
    ɵɵelement(2, "span", 10);
    ɵɵelementEnd();
    ...
    ɵɵlistener("mousedown", function ImageCropperComponent_div_4_ng_container_2_Template_span_mousedown_5_listener($event) {
      ...
      return ɵɵresetView(ctx_r13.startMove($event, ctx_r13.moveTypes.Resize, "topright"));
    })("touchstart", function ImageCropperComponent_div_4_ng_container_2_Template_span_touchstart_5_listener($event) {
      ɵɵrestoreView(_r11);
      const ctx_r14 = ɵɵnextContext(2);
      return ɵɵresetView(ctx_r14.startMove($event, ctx_r14.moveTypes.Resize, "topright"));
    });
    ɵɵelement(6, "span", 10);
    ɵɵelementEnd();
    ...
    ɵɵlistener("mousedown", function ImageCropperComponent_div_4_ng_container_2_Template_span_mousedown_9_listener($event) {
      ...
      return ɵɵresetView(ctx_r15.startMove($event, ctx_r15.moveTypes.Resize, "bottomright"));
    })("touchstart", function ImageCropperComponent_div_4_ng_container_2_Template_span_touchstart_9_listener($event) {
      ɵɵrestoreView(_r11);
      const ctx_r16 = ɵɵnextContext(2);
      return ɵɵresetView(ctx_r16.startMove($event, ctx_r16.moveTypes.Resize, "bottomright"));
    });
    ...
    ɵɵlistener("mousedown", function ImageCropperComponent_div_4_ng_container_2_Template_span_mousedown_13_listener($event) {
      ...
      return ɵɵresetView(ctx_r17.startMove($event, ctx_r17.moveTypes.Resize, "bottomleft"));
      ...
      return ɵɵresetView(ctx_r18.startMove($event, ctx_r18.moveTypes.Resize, "bottomleft"));
    });
    ...
    ɵɵlistener("mousedown", function ImageCropperComponent_div_4_ng_container_2_Template_span_mousedown_17_listener($event) {
      ...
      return ɵɵresetView(ctx_r19.startMove($event, ctx_r19.moveTypes.Resize, "top"));
      ...
      return ɵɵresetView(ctx_r20.startMove($event, ctx_r20.moveTypes.Resize, "top"));
    });
    ɵɵelementEnd();
    ...
    ɵɵlistener("mousedown", function ImageCropperComponent_div_4_ng_container_2_Template_span_mousedown_18_listener($event) {
      ...
      return ɵɵresetView(ctx_r21.startMove($event, ctx_r21.moveTypes.Resize, "right"));
      ...
      return ɵɵresetView(ctx_r22.startMove($event, ctx_r22.moveTypes.Resize, "right"));
    });
    ɵɵelementEnd();
    ...
    ɵɵlistener("mousedown", function ImageCropperComponent_div_4_ng_container_2_Template_span_mousedown_19_listener($event) {
      ...
      return ɵɵresetView(ctx_r23.startMove($event, ctx_r23.moveTypes.Resize, "bottom"));
      ...
      return ɵɵresetView(ctx_r24.startMove($event, ctx_r24.moveTypes.Resize, "bottom"));
    });
    ɵɵelementEnd();
    ...
    ɵɵlistener("mousedown", function ImageCropperComponent_div_4_ng_container_2_Template_span_mousedown_20_listener($event) {
      ...
      return ɵɵresetView(ctx_r25.startMove($event, ctx_r25.moveTypes.Resize, "left"));
      ...
      return ɵɵresetView(ctx_r26.startMove($event, ctx_r26.moveTypes.Resize, "left"));
    });
    ɵɵelementEnd();
    ɵɵelementContainerEnd();
  }
...
function ImageCropperComponent_div_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    ɵɵlistener("keydown", function ImageCropperComponent_div_4_Template_div_keydown_0_listener($event) {
      ...
      return ɵɵresetView(ctx_r27.keyboardAccess($event));
    });
    ...
    ɵɵlistener("mousedown", function ImageCropperComponent_div_4_Template_div_mousedown_1_listener($event) {
      ...
      return ɵɵresetView(ctx_r29.startMove($event, ctx_r29.moveTypes.Move));
    })("touchstart", function ImageCropperComponent_div_4_Template_div_touchstart_1_listener($event) {
      ɵɵrestoreView(_r28);
      const ctx_r30 = ɵɵnextContext();
      return ɵɵresetView(ctx_r30.startMove($event, ctx_r30.moveTypes.Move));
    });
    ɵɵelementEnd();
  ...
  if (rf & 2) {
    ...
    ɵɵstyleProp("top", ctx_r2.cropper.y1, "px")("left", ctx_r2.cropper.x1, "px")("width", ctx_r2.cropper.x2 - ctx_r2.cropper.x1, "px")("height", ctx_r2.cropper.y2 - ctx_r2.cropper.y1, "px")("margin-left", ctx_r2.alignImage === "center" ? ctx_r2.marginLeft : null)("visibility", ctx_r2.imageVisible ? "visible" : "hidden");
    ɵɵclassProp("ngx-ic-round", ctx_r2.roundCropper);
    ɵɵattribute("aria-label", ctx_r2.cropperFrameAriaLabel);
    ɵɵadvance(2);
    ɵɵproperty("ngIf", !ctx_r2.hideResizeSquares);
  }
}
...
ImageCropperComponent.ɵcmp = ɵɵdefineComponent({
  ...
  template: function ImageCropperComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      ɵɵtemplate(2, ImageCropperComponent_img_2_Template, 2, 8, "img", 1);
      ɵɵelement(3, "div", 2);
      ɵɵtemplate(4, ImageCropperComponent_div_4_Template, 3, 16, "div", 3);
      ɵɵelementEnd();
    }
    if (rf & 2) {
