...
function NgxSkeletonLoaderComponent_For_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵproperty("ngClass", ɵɵpureFunction5(5, _c0, ctx_r0.appearance === "custom-content", ctx_r0.appearance === "circle", ctx_r0.animation === "progress", ctx_r0.animation === "progress-dark", ctx_r0.animation === "pulse"))("ngStyle", ctx_r0.theme);
...
_NgxSkeletonLoaderComponent.ɵcmp = ɵɵdefineComponent({
  ...
  decls: 2,
  vars: 0,
  consts: [["aria-busy", "true", "aria-valuemin", "0", "aria-valuemax", "100", "role", "progressbar", "tabindex", "-1", 1, "skeleton-loader", 3, "ngClass", "ngStyle"], ["class", "skeleton-loader", "aria-busy", "true", "aria-valuemin", "0", "aria-valuemax", "100", "role", "progressbar", "tabindex", "-1", 3, "ngClass", "ngStyle"]],
  template: function NgxSkeletonLoaderComponent_Template(rf, ctx) {
    if (rf & 1) {
      ɵɵprojectionDef();
      ɵɵrepeaterCreate(0, NgxSkeletonLoaderComponent_For_1_Template, 2, 11, "div", 1, ɵɵrepeaterTrackByIdentity);
    }
    if (rf & 2) {
